module testing::automated::experiments::overlapMergeDeterminism::OverlapMergeDeterminismExperiment
...
void main() {
    runExperiment(
        #Program, 
        |project://syntax-highlighter/src/main/rascal/testing/automated/experiments/overlapMergeDeterminism|
    );
}