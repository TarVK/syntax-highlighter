module testing::automated::experiments::overlapMergeNonDeterminism::OverlapMergenonDeterminismExperiment
...
void main() {
    runExperiment(
        #Program, 
        |project://syntax-highlighter/src/main/rascal/testing/automated/experiments/overlapMergeNonDeterminism|
    );
}