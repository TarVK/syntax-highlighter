module testing::automated::experiments::\type::simpleTypeRecognition::SimpleTypeRecognitionExperiment
...
void main() {
    runExperiment(
        #Program, 
        |project://syntax-highlighter/src/main/rascal/testing/automated/experiments/type/simpleTypeRecognition|
    );
}