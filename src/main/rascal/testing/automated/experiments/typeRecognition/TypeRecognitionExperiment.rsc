module testing::automated::experiments::typeRecognition::TypeRecognitionExperiment
...
void main() {
    runExperiment(
        #Program, 
        |project://syntax-highlighter/src/main/rascal/testing/automated/experiments/typeRecognition|,
