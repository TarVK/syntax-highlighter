module testing::automated::experiments::typeRecognition2::TypeRecognitionExperiment2
...
void main() {
    runExperiment(
        #Program, 
        |project://syntax-highlighter/src/main/rascal/testing/automated/experiments/typeRecognition2|
    );
}