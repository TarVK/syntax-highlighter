module testing::automated::tests::overlapMergeNonDeterminism::OverlapMergenonDeterminismTest
...
void main() {
    runTest(
        #Program, 
        |project://syntax-highlighter/src/main/rascal/testing/automated/tests/overlapMergeNonDeterminism|
    );
}