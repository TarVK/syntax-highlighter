module testing::automated::tests::overlapMergeNonDeterminismFailed::OverlapMergeNonDeterminismFailedTest
...
void main() {
    runTest(
        #Program, 
        |project://syntax-highlighter/src/main/rascal/testing/automated/tests/overlapMergeNonDeterminismFailed|
    );
}