module testing::automated::tests::relaxedMergingIfElseNoHalt::RelaxedMergingIfElseNoHaltTest
...
void main() {
    runTest(
        #Program, 
        |project://syntax-highlighter/src/main/rascal/testing/automated/tests/relaxedMergingIfElseNoHalt|,
        autoTestConfig(testConfig=testConfig(
