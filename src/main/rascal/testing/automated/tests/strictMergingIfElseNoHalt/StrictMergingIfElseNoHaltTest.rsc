module testing::automated::tests::strictMergingIfElseNoHalt::StrictMergingIfElseNoHaltTest
...
void main() {
    runTest(
        #Program, 
        |project://syntax-highlighter/src/main/rascal/testing/automated/tests/strictMergingIfElseNoHalt|,
