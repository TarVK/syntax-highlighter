module testing::manual::monarchTest
...
// syntax Program = Id*;
// lexical Id = @category="keyword" ([a-z] !<< [a-z][a-z0-9]* !>> [a-z0-9]) \ KW;
// keyword KW = "for"|"in"|"if"|"true"|"false"|"else";
// layout Layout = WhitespaceAndComment* !>> [\ \t\n\r%];
// lexical WhitespaceAndComment 
//    = [\ \t\n\r]
...
void main() {
    ...
    loc output = |project://syntax-highlighter/outputs/monarchGrammar.json|;
    writeJSON(output, monarchGrammar, indent=4);
